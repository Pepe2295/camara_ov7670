...
set rc [catch {
  ...
  open_checkpoint design_1_wrapper_opt.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source /../../home/jose/Vivado/camra/arc.tcl"
    source /../../home/jose/Vivado/camra/arc.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script /../../home/jose/Vivado/camra/arc.tcl failed"
    return -code error
  }
