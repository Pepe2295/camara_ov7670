...
proc create_root_design { parentCell } {
  ...
  set vga_blue_0 [ create_bd_port -dir O -from 4 -to 0 vga_blue_0 ]
  set vga_green_0 [ create_bd_port -dir O -from 5 -to 0 vga_green_0 ]
  set vga_hsync_0 [ create_bd_port -dir O vga_hsync_0 ]
  set vga_red_0 [ create_bd_port -dir O -from 4 -to 0 vga_red_0 ]
  ...
  connect_bd_net -net Net [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins debounce_0/clk] [get_bd_pins ov7670_controller_0/clk]
  ...
  connect_bd_net -net ov7670_controller_0_reset [get_bd_ports reset_1] [get_bd_pins ov7670_controller_0/reset]
